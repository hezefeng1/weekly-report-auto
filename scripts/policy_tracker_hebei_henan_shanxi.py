...
CITY_WEBSITE = {
    # 河北省
    "邢台市": "http://rsj.xingtai.gov.cn",
    "唐山市": "http://rsj.tangshan.gov.cn",
    "辛集市": "http://rsj.xinji.gov.cn",
    "保定市": "http://rsj.baoding.gov.cn",
    "沧州市": "http://rsj.cangzhou.gov.cn",
    "衡水市": "http://rsj.hengshui.gov.cn",
    "廊坊市": "http://rsj.langfang.gov.cn",
    "石家庄市": "http://rsj.shijiazhuang.gov.cn",
    "张家口市": "http://rsj.zjk.gov.cn",
    # 河南省
    "信阳市": "http://rsj.xinyang.gov.cn",
    "安阳市": "http://rsj.anyang.gov.cn",
    "焦作市": "http://rsj.jiaozuo.gov.cn",
    "洛阳市": "http://rsj.ly.gov.cn",
    "漯河市": "http://rsj.luohe.gov.cn",
    "南阳市": "http://rsj.nanyang.gov.cn",
    "三门峡市": "http://rsj.smx.gov.cn",
    "商丘市": "http://rsj.shangqiu.gov.cn",
    "新乡市": "http://rsj.xinxiang.gov.cn",
    "郑州市": "http://rsj.zhengzhou.gov.cn",
    "平顶山市": "http://rsj.pds.gov.cn",
    "濮阳市": "http://rsj.puyang.gov.cn",
    # 山西省
    "大同市": "http://rsj.datong.gov.cn",
    "晋中市": "http://rsj.jinzhong.gov.cn",
    "吕梁市": "http://rsj.lvliang.gov.cn",
}
...
任务：搜索2026年1月1日之后新发布的企业补贴政策，覆盖河北省、河南省、山西省，输出表格格式政策追踪报告。
...
请开始生成报告。"""
    ...
    user_prompt = f"请生成2026年人社补贴政策追踪报告（河北河南山西），政策发布日期为2026年1月1日之后，截止当前日期（{today}）仍未过期的政策。严格按照固定格式输出。"
...
def send_rich_text_message(access_token, receive_id, rows, region="河北河南山西"):
...
def main():
    ...
    print("\n4. 发送富文本消息...")
    send_rich_text_message(token, RECEIVE_OPEN_ID_POLICY, rows, "河北河南山西")
