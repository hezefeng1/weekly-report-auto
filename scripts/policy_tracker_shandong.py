...
# ==================== 城市官网映射 ====================
CITY_WEBSITE = {
    "滨州市": "http://rsj.binzhou.gov.cn",
    "昌邑市": "http://rsj.changyi.gov.cn",
    "德州市": "http://rsj.dezhou.gov.cn",
    "东营市": "http://rsj.dongying.gov.cn",
    "肥城市": "http://rsj.feicheng.gov.cn",
    "海阳市": "http://rsj.haiyang.gov.cn",
    "菏泽市": "http://rsj.heze.gov.cn",
    "济南市": "http://rsj.jinan.gov.cn",
    "济宁市": "http://rsj.jining.gov.cn",
    "莱阳市": "http://rsj.laiyang.gov.cn",
    "莱州市": "http://rsj.laizhou.gov.cn",
    "聊城市": "http://rsj.liaocheng.gov.cn",
    "临沂市": "http://rsj.linyi.gov.cn",
    "青岛市": "http://hrss.qingdao.gov.cn",   # 青岛市人社局特殊域名
    "青州市": "http://rsj.qingzhou.gov.cn",
    "日照市": "http://rsj.rizhao.gov.cn",
    "乳山市": "http://rsj.rushan.gov.cn",
    "寿光市": "http://rsj.shouguang.gov.cn",
    "泰安市": "http://rsj.taian.gov.cn",
    "威海市": "http://rsj.weihai.gov.cn",
    "潍坊市": "http://rsj.weifang.gov.cn",
    "新泰市": "http://rsj.xintai.gov.cn",
    "烟台市": "http://rsj.yantai.gov.cn",
    "枣庄市": "http://rsj.zaozhuang.gov.cn",
    "诸城市": "http://rsj.zhucheng.gov.cn",
    "淄博市": "http://rsj.zibo.gov.cn",
}
...
def generate_policy_report():
    """调用 DeepSeek API 生成政策追踪报告（山东省）"""
    today = datetime.now().strftime("%Y年%m月%d日")

    system_prompt = """你是人社政策情报分析AI。

任务：搜索2026年1月1日之后新发布的企业补贴政策，覆盖山东省，输出表格格式政策追踪报告。
...
请开始生成报告。"""
    ...
    user_prompt = f"请生成2026年人社补贴政策追踪报告（山东省），政策发布日期为2026年1月1日之后，截止当前日期（{today}）仍未过期的政策。严格按照固定格式输出。"
...
def send_rich_text_message(access_token, receive_id, rows, region="山东"):
...
def main():
    ...
    print("\n4. 发送富文本消息...")
    send_rich_text_message(token, RECEIVE_OPEN_ID_POLICY, rows, "山东")
